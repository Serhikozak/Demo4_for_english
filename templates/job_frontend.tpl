...
sonar.sources=.</properties>
    ...
    <hudson.tasks.Shell>
      <command>sed -i -e s+https://fierce-shore-32592.herokuapp.com+http://${lb}:8080+g /var/lib/jenkins/workspace/job_frontend/src/app/services/token-interceptor.service.ts
yarn install
ng build --prod
</command>
    </hudson.tasks.Shell>
            ...
            <jenkins.plugins.publish__over__ssh.BapSshPublisher plugin="publish-over-ssh@1.20.1">
              ...
              <transfers>
                <jenkins.plugins.publish__over__ssh.BapSshTransfer>
                  ...
                  <execCommand>gcloud auth activate-service-account --key-file /tmp/ansible/.ssh/devops-eb6d149e8256.json
